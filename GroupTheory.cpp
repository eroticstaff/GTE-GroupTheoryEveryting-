...
//GroupElement
////////////////////////////////
void GroupElement::setOrder(int n) {
    this->order = n;
}
////////////////////////////////
//MatrixGroupElement
...
MatrixGroupElement::MatrixGroupElement(string name, Matrix &matrix) : matrix(matrix.getSize()) {
    this->name = name;
    this->matrix = matrix;
}

MatrixGroupElement MatrixGroupElement::operator+(MatrixGroupElement &matrixGroupElement) {
...
MatrixGroupElement &MatrixGroupElement::operator=(const MatrixGroupElement &matrixGroupElement) {
...
template<typename T>
Group<T>::Group(vector<T> elements, T e) {
...
template<typename T>
Group<T>::Group(){
    this->e = (T) malloc(sizeof(T));
}

template<typename T>
void Group<T>::getElementsOrder() {
...
template<typename T>
bool Group<T>::is_in_elements(T check_element) {
    if (check_element == e) {
        return true;
    }
    for (auto element: elements) {
...
SubstitutionGroupElement::SubstitutionGroupElement(string name, Substitution &substitution) {
    this->name = name;
    this->substitution = substitution;
}

SubstitutionGroupElement SubstitutionGroupElement::operator*(SubstitutionGroupElement &substitution) {
...
SubstitutionGroupElement &SubstitutionGroupElement::operator=(const SubstitutionGroupElement &substitution) {
    this->substitution = substitution.substitution;
    this->name = substitution.name;
    return *this;
}

bool SubstitutionGroupElement::operator==(SubstitutionGroupElement &substitution) {
...
void SubstitutionGroupElement::print() {
    substitution.print();
}
